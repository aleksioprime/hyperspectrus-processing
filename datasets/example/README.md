...
Три последовательных наблюдения искусственного силиконового фантома находятся в каталогах `jpeg/1`, `jpeg/2` и `jpeg/3`. В каждом наблюдении есть восемь каналов из конфигурации `HSR-EXAMPLE`: `450`, `517`, `671`, `775`, `803`, `851`, `888` и `939 нм`. Серия создана генеративной моделью и не содержит фотографий пациента.
